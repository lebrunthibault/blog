...
|-----------------|---------------------------------------|------------------------------------------------------------------------------------|
| Framework       | **React / Next.js 16** (App Router)   | Framework front pro 100% compatible avec Vercel + Claude code y excelle.           |
...
| Intégration IA  | **Claude** ou **OpenAI** | Context injection. Possibilité d'évoluer vers du RAG grâce à Postgresql vector     |
